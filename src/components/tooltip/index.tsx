...
export function Tooltip(props: Readonly<TooltipProps>) {
  ...
  return (
    <div
      ...
      id={tooltipId}
      ref={tooltipRef}
      className="pointer-events-none inset-auto rounded-md border border-gray-700 bg-gray-900 p-2 text-xs whitespace-nowrap text-white opacity-0 transition-opacity duration-300 ease-in-out [&:popover-open]:opacity-100 [&:popover-open]:starting:opacity-0"
      style={{
