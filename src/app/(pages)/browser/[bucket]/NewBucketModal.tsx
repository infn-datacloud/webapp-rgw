...
import { CreateBucketArgs } from "@/services/s3/types";
...
export const NewBucketModal = (props: NewBucketModalProps) => {
  ...
  const isBucketNameValid = (): boolean => {
    return bucketValidator.test(bucketName);
  };

  const validateBucketName = () => {
    setError(isBucketNameValid() ? undefined : bucketInvalidErrorMessage);
  };
